...
// let browsreOpenPromise = puppeteer.launch({
//     headless:false,
...
//         let visitingLoginPagePromise = cTabs.goto("https://www.hackerrank.com/auth/login");
//         return visitingLoginPagePromise;
//     })
//     .then(function () {
//         console.log("Hackerrank login page opened");
//         let emailWillBeTypedPromise = cTabs.type("input[name='username']", email);
//         return emailWillBeTypedPromise;
//       })
//       .then(function () {
//         console.log("email is typed");
//         let passwordWillBeTypedPromise = cTabs.type("input[type='password']", password);
//         return passwordWillBeTypedPromise;
//       })
//       .then(function () {
//         console.log("password has been typed");
//         let willBeLoggedInPromise = cTabs.click(
...
//         let allQuesPromise = cTabs.waitForSelector(
...
//             let allElemArr = document.querySelector('a[data-analytics="ChallengeListChallengeName"]');
//             let linkArr = [];
//             for(let i = 0; i<allElemArr.clientHeight; i++){
//               linkArr.push(allElemArr[i].getAttribute("href"));
//             }
//             return linkArr;
//         }
//         let linkArrPromise = cTabs.evaluate(getAllQuesLink);
...
//         let waitForSelectorPromise = cTabs.waitForSelector(algoBtn);
//         waitForSelectorPromise
//           .then(function () {
//             console.log("algo btn is found");
//             let clickPromise = cTabs.click(algoBtn);
//             return clickPromise;
//           })
//           .then(function () {
...
browserOpenPromise //fulfill
  ...
  .then(function (data) {
    ...
    // delay to fool bots that this is human not bot
